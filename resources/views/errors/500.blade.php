            ...
            <div ng-controller="loginCtrl" class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
						...
						<span class="text-center txt-danger" style="font-size: 20px;">Oops! Internal Server Error</span>
						<p class="text-center txt-danger" style="font-size: 16px;" >There was an Error. Please try again later. That's all we know.</p>
                    </div>
                <!-- 2-1 block end -->
                </div>
