                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="login-card card-block">
                            <form class="md-float-material" name="frmData" action="{{ URL::to('/authenticate') }}" method="POST">
                                {{ csrf_field() }}
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="md-input-wrapper">
                                            <input type="text" class="md-form-control text-center" name="username" required/>
                                            <label>Username</label>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="md-input-wrapper">
                                            <input type="password" class="md-form-control text-center" name="password" required/>
                                ...
                                <div class="row">
                                    ...
                                    <div class="alert alert-danger alert-dismissable">
                                        ...
                                        <p class="text-white pull-left fs-18"><strong>Login Failed!</strong> {{ session('message') }}</p>
